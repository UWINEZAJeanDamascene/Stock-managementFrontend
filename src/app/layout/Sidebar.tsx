...
const systemNav: NavSection = {
  ...
  items: [
    ...
    { nameKey: 'nav.serialNumbers', href: '/serial-numbers', icon: Package, permission: 'stock:read' as const },
    ...
    { nameKey: 'nav.purchases', href: '/purchases', icon: ShoppingCart, permission: 'stock:read' as const },
